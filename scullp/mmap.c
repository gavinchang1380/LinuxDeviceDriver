...
static void scullp_vma_open(struct vm_area_struct *vma)
{
...
static void scullp_vma_close(struct vm_area_struct *vma)
{
	struct scullp_dev *dev = vma->vm_private_data;
...
static struct vm_operations_struct scullp_vm_ops = {
