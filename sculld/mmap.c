...
static void sculld_vma_open(struct vm_area_struct *vma)
{
...
static void sculld_vma_close(struct vm_area_struct *vma)
{
	struct sculld_dev *dev = vma->vm_private_data;
...
static struct vm_operations_struct sculld_vm_ops = {
